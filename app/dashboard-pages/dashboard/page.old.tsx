      ...
      <nav className="border-b border-gray-800 bg-gray-900/50 backdrop-blur">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link href="/pricing">
              <Button size="sm" className="bg-gradient-to-r from-green-400 to-blue-400 hover:from-green-500 hover:to-blue-500">
        ...
        >
            ...
            {challenges.length > 0 ? (
              challenges.map((challenge, i) => (
                ...
                >
                  ...
                  <button
                    onClick={() => router.push('/dashboard-pages/place-pick')}
                    className="ml-4 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-semibold transition"
                  >
                    Placer un Pick
                  </button>
                </motion.div>
          ...
          <div className="mt-6 flex gap-4">
            <Link href="/dashboard-pages/create-challenge">
              <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-semibold transition">
                + CRÉER UN CHALLENGE
              </button>
            </Link>
            <Link href="/dashboard-pages/place-pick">
              <button className="px-6 py-2 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold transition">
                🎯 PLACER UN PICK
              </button>
            </Link>
          </div>
