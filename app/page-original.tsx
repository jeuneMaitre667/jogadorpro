      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <Link href="/affiliate" className="text-gray-300 hover:text-green-400 transition">Affiliation</Link>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="#affiliate" className="hover:text-white transition">Programme Affiliation</a></li>
              </ul>
            </div>
            <div>
